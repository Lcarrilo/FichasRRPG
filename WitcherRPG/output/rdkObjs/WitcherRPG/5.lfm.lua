...
local function constructNew_frmSR6e3_svg()
    ...
    obj.layout2:setLeft(440);
    obj.layout2:setTop(20);
    obj.layout2:setWidth(400);
    obj.layout2:setHeight(760);
    ...
    obj.layout3:setLeft(860);
    obj.layout3:setTop(20);
    obj.layout3:setWidth(400);
    obj.layout3:setHeight(760);
    ...
    obj.layout4:setLeft(1280);
    obj.layout4:setTop(20);
    obj.layout4:setWidth(400);
    obj.layout4:setHeight(760);
...
function newfrmSR6e3_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmSR6e3_svg();
      end,
      function()
...
frmSR6e3_svg = _frmSR6e3_svg;
Firecast.registrarForm(_frmSR6e3_svg);

return _frmSR6e3_svg;
